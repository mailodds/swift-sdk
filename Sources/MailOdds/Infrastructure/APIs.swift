...
open class MailOddsAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://api.mailodds.com/v1",
    ...
    public static let shared = MailOddsAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: MailOddsAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: MailOddsAPIConfiguration = MailOddsAPIConfiguration.shared) {
        self.method = method
